...
- sur jenkins, installer les plugins sonar, htmlpublisher, jobConfigHistory, multiple-scms, pitmutation  
...
docker exec -ti traineegrp-jenkins java -jar /var/jenkins_home/war/WEB-INF/jenkins-cli.jar -s http://localhost:8080 install-plugin multiple-scms  
